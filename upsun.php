...
putenv('DISTRIBUTION_MAIN_URL=' . $platformConfig->getRoute('main')['url']);
...
if ($platformConfig->hasRelationship('mariadb')) {
    $databaseConfig = $platformConfig->credentials('mariadb');
